...
import TokenAddressInput from '../basic/input/TokenAddressInput';

export default function PairRewarderSetPrize({ pairRewarderAddress }: { pairRewarderAddress?: Address }) {
